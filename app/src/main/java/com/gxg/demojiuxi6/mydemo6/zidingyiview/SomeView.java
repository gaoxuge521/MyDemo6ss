...
/**
 * Created by gateway on 2017/7/14.
 */
public class SomeView extends View {
    ...
    private void drawRegion(Canvas canvas) {
        ...
        for(int i =0;i<count;i++){
            double parent = data[i]/maxValue;
            float x = (float) (centerX+radius*Math.cos(angle*i)*parent);
            float y = (float) (centerY+radius*Math.sin(angle*i)*parent);
            if(i==0){
    ...
    private String[] titles = {"很好", "等待", "广告歌", "二恶恶", "贵公司e", "广告歌"};
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        Log.e(TAG, "onSizeChanged: " + w + "  0" + h + "   " + oldw + "   " + oldh);
