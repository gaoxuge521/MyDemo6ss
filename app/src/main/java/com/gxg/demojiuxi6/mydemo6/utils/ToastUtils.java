package com.gxg.demojiuxi6.mydemo6.utils;
...
import com.gxg.demojiuxi6.mydemo6.MainApplication;
...
public final class ToastUtils {
    ...
    public static void showShortToastSafe(final CharSequence text) {
        sHandler.post(new Runnable() {
            @Override
            public void run() {
                showShortToast(text, Toast.LENGTH_SHORT);
            }
        });
    }
    ...
    public static void showShortToastSafe(final @StringRes int resId) {
        sHandler.post(new Runnable() {
            @Override
            public void run() {
                showShortToast(resId, Toast.LENGTH_SHORT);
            }
        });
    }
    ...
    public static void showShortToastSafe(final @StringRes int resId, final Object... args) {
        sHandler.post(new Runnable() {
            @Override
            public void run() {
                showShortToast(resId, Toast.LENGTH_SHORT, args);
            }
        });
    }
    ...
    public static void showShortToastSafe(final String format, final Object... args) {
        sHandler.post(new Runnable() {
            @Override
            public void run() {
                showShortToast(format, Toast.LENGTH_SHORT, args);
            }
        });
    }
    ...
    public static void showLongToastSafe(final CharSequence text) {
        sHandler.post(new Runnable() {
            @Override
            public void run() {
                showShortToast(text, Toast.LENGTH_LONG);
            }
        });
    }
    ...
    public static void showLongToastSafe(final @StringRes int resId) {
        sHandler.post(new Runnable() {
            @Override
            public void run() {
                showShortToast(resId, Toast.LENGTH_LONG);
            }
        });
    }
    ...
    public static void showLongToastSafe(final @StringRes int resId, final Object... args) {
        sHandler.post(new Runnable() {
            @Override
            public void run() {
                showShortToast(resId, Toast.LENGTH_LONG, args);
            }
        });
    }
    ...
    public static void showLongToastSafe(final String format, final Object... args) {
        sHandler.post(new Runnable() {
            @Override
            public void run() {
                showShortToast(format, Toast.LENGTH_LONG, args);
            }
        });
    }
     ...
     * @param duration 显示时长
     */
    private static void showShortToast(@StringRes int resId, int duration) {
        showShortToast(MainApplication.getContext().getResources().getText(resId).toString(), duration);
    }
     ...
     * @param args     参数
     */
    private static void showShortToast(@StringRes int resId, int duration, Object... args) {
        showShortToast(String.format(MainApplication.getContext().getResources().getString(resId), args), duration);
    }
     ...
     * @param args     参数
     */
    private static void showShortToast(String format, int duration, Object... args) {
        showShortToast(String.format(format, args), duration);
    }
     ...
     * @param duration 显示时长
     */
    private static void showShortToast(CharSequence text, int duration) {
